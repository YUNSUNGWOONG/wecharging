        ...
        actions += [
            Node(
                ...
                parameters=[{"robot_description": ParameterValue(Command([
                    "xacro ", robot_xacro, " robot_id:=", rid]), value_type=str)}],
            ),
            Node(
...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        IncludeLaunchDescription(
            ...
            # Ogre v1 GUI render engine: avoids the Ogre2 black-viewport issue
            # on NVIDIA + Gazebo Fortress (see single_robot.launch.py).
            launch_arguments={"gz_args": [world, " -r --render-engine-gui ogre"]}.items(),
        ),
