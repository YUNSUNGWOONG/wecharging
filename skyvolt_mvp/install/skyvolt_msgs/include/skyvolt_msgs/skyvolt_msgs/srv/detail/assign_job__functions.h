...
#ifndef SKYVOLT_MSGS__SRV__DETAIL__ASSIGN_JOB__FUNCTIONS_H_
#define SKYVOLT_MSGS__SRV__DETAIL__ASSIGN_JOB__FUNCTIONS_H_
...
/// Initialize srv/AssignJob message.
/**
...
/// Finalize srv/AssignJob message.
/**
...
/// Create srv/AssignJob message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * skyvolt_msgs__srv__AssignJob_Request__init().
...
/// Destroy srv/AssignJob message.
/**
 * It calls
 * skyvolt_msgs__srv__AssignJob_Request__fini()
...
/// Check for srv/AssignJob message equality.
/**
...
/// Initialize array of srv/AssignJob messages.
/**
...
/// Finalize array of srv/AssignJob messages.
/**
 * It calls
 * skyvolt_msgs__srv__AssignJob_Request__fini()
...
/// Create array of srv/AssignJob messages.
/**
 * It allocates the memory for the array and calls
 * skyvolt_msgs__srv__AssignJob_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/AssignJob messages.
/**
 * It calls
 * skyvolt_msgs__srv__AssignJob_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/AssignJob message array equality.
/**
...
/// Copy an array of srv/AssignJob messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * skyvolt_msgs__srv__AssignJob_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_skyvolt_msgs
...
/**
 * It calls
 * skyvolt_msgs__srv__AssignJob_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_skyvolt_msgs
...
/**
 * It allocates the memory for the array and calls
 * skyvolt_msgs__srv__AssignJob_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_skyvolt_msgs
...
/**
 * It calls
 * skyvolt_msgs__srv__AssignJob_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // SKYVOLT_MSGS__SRV__DETAIL__ASSIGN_JOB__FUNCTIONS_H_
